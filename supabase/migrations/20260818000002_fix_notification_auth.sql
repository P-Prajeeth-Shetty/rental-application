...
begin
  perform net.http_post(
    ...
    headers := jsonb_build_object(
      ...
      'Authorization', 'Bearer ' || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9hYWZycWpzb2lxaW1kdnVubWhrIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODU1NDk2NjAsImV4cCI6MjEwMTEyNTY2MH0.3dbP8GV4jl7LyTswos1EJGqRp_oOdv2JTCVxtSZrmho'
    ),
